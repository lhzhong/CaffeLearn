...
data = sio.loadmat('/home/cpss/caffe/zhong/KTH/feature_extract/flow/feature/feature_fc6.mat')
data = data['feats']
data = preprocessing.scale(data)

file_name='/home/cpss/caffe/zhong/KTH/feature_extract/flow/feature/label.txt'
labels=[]
