...
data = sio.loadmat('/home/cpss/caffe/zhong/KTH/feature_extract/rgb/feature/feature_fc6.mat')
data = data['feats']
data = preprocessing.scale(data)

file_name='/home/cpss/caffe/zhong/KTH/feature_extract/rgb/feature/label.txt'
labels=[]
with open(file_name) as file_object:
    for line in file_object:
        labels.append(line)
labels = np.array(labels,dtype=int)
data_labels = labels[:42200]
